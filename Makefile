...
KERNELFLAGS     = -mcpu=cortex-a53 -mtune=cortex-a53 -mfpu=neon-vfpv4 -marm -munaligned-access
...
KBUILD_CFLAGS	+= -O3 $(call cc-disable-warning,maybe-uninitialized,) -Wno-array-bounds
endif
